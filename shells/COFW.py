...
Me_3090_COFW_OFF = ["logs/COFW/hourglass/heatmap_rcnn_T/", "logs/COFW/hourglass/heatmap_rcnn_S/", "logs/COFW/hourglass/heatmap_rcnn_B/"]
CUDA_ID = 0
MODEL_DIR = "COFW_ION"
...
if __name__ == "__main__":
    ...
    for dir_path in Me_3090_COFW_OFF:
